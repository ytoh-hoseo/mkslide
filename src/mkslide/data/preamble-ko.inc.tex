...
% block 스타일
\setbeamercolor{block title}{bg=mainred!70, fg=white}
\setbeamercolor{block body}{bg=mainred!10, fg=black}

\setbeamercolor{block title alerted}{bg=mainred, fg=white}
\setbeamercolor{block body alerted}{bg=mainred!20, fg=black}
